<?php
/**
 * vnidigital functions and definitions
 *
...
if ( ! function_exists( 'vnidigital_setup' ) ) :
	/**
	 ...
	 */
	function vnidigital_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on vnidigital, use a find and replace
		 * to change 'vnidigital' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'vnidigital', get_template_directory() . '/languages' );
		...
		add_theme_support( 'custom-background', apply_filters( 'vnidigital_custom_background_args', array(
 ...
 */
function vnidigital_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'vnidigital_content_width', 640 );
}
add_action( 'after_setup_theme', 'vnidigital_content_width', 0 );
 ...
 */
function vnidigital_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'vnidigital' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'vnidigital' ),
...
add_action( 'widgets_init', 'vnidigital_widgets_init' );
...
add_action( 'wp_enqueue_scripts', 'vnidigital_scripts' );
